        ...
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5">
            ...
            <h1 class="mb-3 bread">Login</h1>
            	<p class="breadcrumbs mb-0"><span>Login for students</span></p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-12 col-lg-12 mb-5">
           ...
           <form action="#" class="p-5 bg-white">
             ...
             <div class="form-group">
               ...
               <input type="text" class="form-control" placeholder="Enter Your Email/Username" required>
             </div>
             <div class="form-group">
                  <label for="Username">Password</label>
               <input type="text" class="form-control" placeholder="Enter Your Password" required>
             </div>
