...
if(isset($_POST['email']))
{
      ...
      //  print_r($email);
        ...
        $output.='<p>-------------------------------------------------------------</p>';
        $output.='<p><a href="https://www.internstorm.com/reset_password.php?key='.$key.'&email='.$email.'&action=reset" target="_blank">https://www.internstorm.com/reset_password.php?key='.$key.'&email='.$email.'&action=reset</a></p>';
        $output.='<p>-------------------------------------------------------------</p>';
        ...
        $mail = new PHPMailer();
                    ...
                    echo "Mailer Error: " . $mail->ErrorInfo;
                        ...
                        $enter = 1;
                        $success = "Verification mail is successfully send to registered mail id with instructions on how to reset your password";
                    	}
        		}
