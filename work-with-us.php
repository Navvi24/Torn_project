...
<!--End of Tawk.to Script-->
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="work-with-us.php" class="nav-link">Work with us</a></li>
    ...
    <div class="hero-wrap hero-wrap-2" style="background-image: url('images/work_bg3.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-8 ftco-animate text-center text-md-left mb-5">
          	<p class="breadcrumbs mb-0"><span class="mr-3"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Work with us</span></p>
            <h1 class="mb-3 bread">Work with us</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row justify-content-center">
              ...
              <a href="#">hello@internstorm.com</a>
    				</div>
    			</div>
    		</div>
    	</div>
