...
<!--End of Tawk.to Script-->
  <body>
    ...
    <!-- END nav -->
    <div class="hero-wrap hero-wrap-2" style="background-image: url('images/our-clients.gif');" data-stellar-background-ratio="0.5">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="team d-md-flex">
            <div class="img" style="background-image: url(images/client1.png);"></div>
            <div class="text pl-md-4">
              <h2>Couponmonster</h2>
              <p>Couponmonster.co is an all-inclusive coupon distribution company that ties up with various businesses around the city and brings you the best offers. #usekiyakya?</p>
            </div>
          </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <div class="team d-md-flex">
            <div class="img" style="background-image: url(images/client4.png);"></div>
            <div class="text pl-md-4">
              <h2>Orbiting</h2>
